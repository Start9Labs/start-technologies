...
| Column                    | Description                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Toggle**                | Enable or disable the address. Your server serves an address while it is enabled, and refuses SSL connections to it once you switch it off — see the note below for the two cases where it goes on answering. Public IPv4 addresses are off by default. All other addresses are on by default.                                                                                                            |
...
> - An address served without SSL goes on answering — a plain-HTTP address, and the addresses of a raw-TCP interface such as a P2P or ZMQ endpoint. Your server forwards a plaintext port for a whole gateway at once, so every address on that gateway shares one rule.
