...
- **Service-container cleanup finishes after an unresponsive runtime.** StartOS
  bounds the runtime shutdown wait so it can release the container's network
  routes and continue teardown.
