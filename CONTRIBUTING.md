...
`build/test/testenv.Dockerfile`. The derived image adds the SquashFS tools used by
the s9pk integration tests to the standard Rust builder; Docker caches it after
the first build.
